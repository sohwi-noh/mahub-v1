defmodule SymphonyElixir.Config.Schema do
  ...
  defmodule Tracker do
    ...
    embedded_schema do
      ...
      field(:retry_exhausted_state, :string)
    end
  ...
  defmodule Agent do
    ...
    embedded_schema do
      ...
      field(:max_retry_attempts, :integer)
  ...
  defp finalize_settings(settings) do
    tracker = %{
      settings.tracker
      | endpoint: resolve_secret_setting(settings.tracker.endpoint, System.get_env("LINEAR_API_ENDPOINT")),
